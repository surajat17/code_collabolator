      ...
      <div class="modal-wrapper flex flex-col max-w-3xl mx-auto rounded-lg shadow-lg">
          <div class="px-8 pt-10 pb-4">
              <div class="flex flex-col">
                  ...
                  <div class="flex w-full"><input type="text" name="link" id="link" class="link w-full link-hover py-2 my-3 border px-4 rounded-pill" readonly="" value="https://codelabbs.herokuapp.com/room/join/${roomid}">
                  </div>
              ...
              <div class="flex flex-col mt-5 py-4 border-t border-gray-300">
                  ...
                  <a href="https://codelabbs.herokuapp.com/admin/${roomid}/${adminCode}"> <button class="btn modal-btn" >Go to Admin Panel</button></a>
              </div>
          </div>
      </div>
  </div>`;
